...
void loop()
{
  ...
  if (vw_get_message((uint8_t *)buf, &buflen))
  {
    ...
    if ((char)buf[0] == 'j') //verificamos el inicio de trama
    {
      for (i = 1; i < buflen; i++)
      {
    ...
    else if ((char)buf[0] == 'j') //verificamos el inicio de trama
    {
      for (i = 1; i < buflen; i++)
      {
        DatoCadena.concat((char)buf[i]);
  ...
  String str = "";
  str = "i" + String(dato2); //convertimos el entero a String y agramos un inicio de trama
